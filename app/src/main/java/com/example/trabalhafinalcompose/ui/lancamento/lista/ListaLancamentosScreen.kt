...
import com.example.trabalhafinalcompose.utils.calcularProjecao
import com.example.trabalhafinalcompose.utils.calcularSaldo
import com.example.trabalhafinalcompose.utils.formatar
...
private fun ListaVazia(modifier: Modifier = Modifier) {
    Column(
        ...
        Image(
            ...
            painter = painterResource(R.drawable.wallet_foreground),
